...
<body>
	...
	<div class="topbar">
		<a href="dashboard" class="topbar-logo">Shop<span>Admin</span></a> <a
			href="dashboard" class="topbar-continue">&larr; Continue Shopping</a>
	</div>

	<div class="page-wrap">
	
		<div class="breadcrumb">
			<a href="dashboard">Dashboard</a> &rsaquo; Shopping Cart <a
				href="checkout" class="btn"> Checkout </a>
		</div>
			...
			<c:otherwise>
						...
						<div class="cart-card">
							...
							<div class="cart-info">
								...
								<div class="cart-unit-price">
									Unit price: <strong>&#8377;${item.product.price}</strong>
								</div>
							</div>
							<div class="cart-right">
								<div class="cart-subtotal">&#8377;${item.totalPrice}</div>
								<div class="qty-control">
									<a href="decrease-quantity?productId=${item.product.id}"
										class="qty-btn">&#8722;</a>
									<div class="qty-num">${item.quantity}</div>
									<a href="increase-quantity?productId=${item.product.id}"
										class="qty-btn">&#43;</a>
								</div>
				...
				<div class="summary-card">
					...
					<div class="summary-row">
						<span>Items (${cart.totalItems})</span> <span class="val">&#8377;${cart.calculateTotal()}</span>
					</div>
					<div class="summary-row discount">
						<span>Discount</span> <span class="val">&#8722; &#8377;0</span>
					</div>
					<div class="summary-row">
						<span>Delivery</span> <span class="val" style="color: #388e3c">FREE</span>
					</div>
					<div class="summary-row total">
						<span>Total</span> <span class="val">&#8377;${cart.calculateTotal()}</span>
					</div>
